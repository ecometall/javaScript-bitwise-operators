...
A simple JavaScript bitwise operators overview project.  
...
*       << - left bitwise shift
*       >> - right bitwise shift
*       >>> - unsigned right bitwise right shift
...
*
*   3. unsigned right bitwise right shift (>>>)
*
*       32 >>> 3 // 32 / 2 -> 16 / 2 -> 8 / 2 -> 4
*       -32 >> 3 // infinity
*
